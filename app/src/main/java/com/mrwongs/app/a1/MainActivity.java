...
//        });
        ...
        AHBottomNavigationItem item1 = new AHBottomNavigationItem("Home", R.drawable.hone45);
        AHBottomNavigationItem item2 = new AHBottomNavigationItem("Order Now", R.drawable.order);
        AHBottomNavigationItem item3 = new AHBottomNavigationItem("Dashboard", R.drawable.dash90);



        int qq = getResources().getDimensionPixelSize(R.dimen._9sdp);
        int qqa = getResources().getDimensionPixelSize(R.dimen._9sdp);
        ...
        bottomNavigation.setAccentColor(Color.parseColor("#ea544e"));
        bottomNavigation.setInactiveColor(Color.parseColor("#1a2534"));
    ...
    AHBottomNavigation.OnTabSelectedListener ob = new AHBottomNavigation.OnTabSelectedListener() {
        ...
        public boolean onTabSelected(int position, boolean wasSelected) {
            switch(position){
                ...
                case 1:
                    mwebView.loadUrl("https://www.swiggy.com/restaurants/wongs-kitchen-kanathur-chennai-320497");
                ...
                case 2:
                    mwebView.loadUrl("https://www.swiggy.com/my-account");
